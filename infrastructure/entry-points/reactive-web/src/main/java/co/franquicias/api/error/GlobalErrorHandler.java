...
public class GlobalErrorHandler implements ErrorWebExceptionHandler {
    ...
    private HttpStatusCode mapStatus(Throwable e) {
        ...
        if (e instanceof ConflictException)                   return HttpStatus.CONFLICT;               // 409

        if (e instanceof NotFoundException)                   return HttpStatus.NOT_FOUND;              // 404
        ...
        if (e instanceof ConstraintViolationException)        return HttpStatus.BAD_REQUEST;            // 400
